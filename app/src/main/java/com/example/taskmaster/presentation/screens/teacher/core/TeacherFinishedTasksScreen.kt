...
import com.example.taskmaster.presentation.components.teacherComponents.task.finished.screenComponent.TeacherFinishedTaskScreenComponent
...
fun TeacherFinishedTasksScreen(navController: NavController) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize(),
        ...
        )
        {
            ...
            TeacherFinishedTaskScreenComponent()
        }
    }
}