...
import com.example.taskmaster.presentation.components.studentComponents.task.taskAnswer.screenComponent.StudentTaskAnswerScreenComponent
import com.google.firebase.auth.FirebaseAuth
import org.koin.androidx.compose.koinViewModel
import org.koin.compose.koinInject

@Composable
fun StudentTaskAnswerScreen(navController: NavController, viewModel : StudentAnswerScreenViewModel) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize(),
        ...
        )
        {
            ...
            StudentTaskAnswerScreenComponent(viewModel)
        }
    }
}